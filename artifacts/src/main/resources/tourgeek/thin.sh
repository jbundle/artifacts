...
# java $DEBUG org.jbundle.thin.Thin systemname=_test mainUserDBName=main programSharedDBName=program_test menu=Thin background=backgrounds/worldmapalpha.gif backgroundcolor=#EEEEFF remotehost=$SERVER codebase=$CODE_BASE
