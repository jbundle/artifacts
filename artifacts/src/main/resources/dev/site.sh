...
mvn clean;mvn site;mv target/site /web/jbundle
cd ../../../../util/osgi-webstart/webstart/
mvn clean;mvn site;mv target/site /web/jbundle/osgi-webstart
cd ../../webapp/site/
mvn clean;mvn site;mv target/site /web/jbundle/webapp
